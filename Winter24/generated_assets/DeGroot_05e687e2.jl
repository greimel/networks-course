...
# ╔═╡ de25be2f-1e59-4db2-87f3-b0ff1c17cc4e
...
# ╔═╡ c37e4148-5071-4f9e-a9f7-67c27a618f0f
round.(T^10_001 - T^10_000, digits = 5)
...
# ╔═╡ 358419a9-0046-48fa-8571-7f38fb6c8158
fonts = (regular = texfont(), bold = texfont(:bold), italic = texfont(:italic))

# ╔═╡ 10ef06bc-70ab-11eb-027d-fb5b67cccd8b
data(b_stacked(T,b0,50)) * mapping(:t => L"time $t$", :opinion, color=:node => "") * visual(Lines) |> x -> draw(x; figure=(; size = (500, 300), fonts))
...
let
	...
	graphplot(fig[1,1], graphs[1]; attr(graphs[1])..., axis=minimal(title = L"T_1"))
	graphplot(fig[1,2], graphs[2]; attr(graphs[2])..., axis=minimal(title = L"T_2"))
	graphplot(fig[2,1], graphs[3]; attr(graphs[3])..., axis=minimal(title = L"T_3"))
	graphplot(fig[2,2], graphs[4]; attr(graphs[4])..., axis=minimal(title = L"T_4"))
...
manifest_format = "2.0"
project_hash = "c78b10d3576ba34815097b13d6c11416322ab344"
...
git-tree-sha1 = "880e88872cc9176f1da82a2a58dcc38992b389a7"
