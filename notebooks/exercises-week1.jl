...
👉 Calculate (by hand) the betweenness centrality of node 5 in the network below. Answer:

Check your answer by uncommenting the calculation in the next cell.
"

# ╔═╡ d6557f8a-6734-11eb-0fd4-0b7b5f602bab
#betweenness_centrality(gg)[5]

# ╔═╡ 11e98628-6734-11eb-1b66-83663e790a78
md"
#### Question 2

👉 Below you can calculate the eigenvector centrality and Bonacich centrality $\alpha=0.2$ and exogenous factors $e_i = 1$ for all nodes $i$. First, answer the following question:
 * Guess which nodes have the highest eigenvector centrality. Guess:

No check your guess with the following code:
"

# ╔═╡ 541b25de-6670-11eb-2ad1-2babaf714216
#eigenvector_centrality(gg)

# ╔═╡ 5b312d16-6670-11eb-2da6-976db9964456
#katz_centrality(gg, 0.2)

# ╔═╡ 45c86e74-6670-11eb-1acd-41f288f6de70
#betweenness_centrality(gg)

# ╔═╡ ff893920-6782-11eb-2728-270f9261597d
md"
Note that the betweenness centrality picksout nodes 5 and 6 as being most central, which corresponds to our intuition. The eigenvector centrality and Katz-Bonacich centrality fail to identify these nodes as being central. We try to obtain some insight into this by making a calculation for the Katz-Bonacich centrality.
...
# ╔═╡ 89b68c4a-6735-11eb-37d5-27748175ab66
md"
Manual definition of the network shown above:
"
...
gg = MetaGraph(df, :x1, :x2);

# ╔═╡ d158181e-666f-11eb-2f70-9dc4b6e53b16
gplot(gg, nodelabel = vertices(gg), layout = spring_layout)


# ╔═╡ 04666c34-6737-11eb-0392-5be7f7836a5d
md"
# The TI co-author network 
"
...
ti_plot = gplot(gc, nodesize=0.1, NODESIZE=0.015, layout=spring_layout, nodestrokelw=1, nodestrokec = "black", nodefillc="orange")
