...
# ╔═╡ 396cd033-000a-41bc-b7c1-44732102ec1c
md"""
...
# ╔═╡ 21b172a7-9815-41dc-bf8e-577a7ccf9b7f
md"""
`banks-assignment.jl` | **Version 0.1** | *last updated: Feb 24*
"""
...
md"""
### Task 1: Avoiding a bank run (X points)

Use the model of _Allen & Gale (2000)_ for this task.

There are four banks ``i \in \{1, 2, 3, 4\}``. The following interbank network is given. The fraction of early types ``\omega_i`` in each bank is random. There are four possible states ``S_j = (\omega_{1j}, \omega_{2j}, \omega_{3j}, \omega_{4j})``
...
S_4 &= (\gamma - \varepsilon, \gamma + \varepsilon, \gamma - \varepsilon, \gamma + \varepsilon) \\
\end{align}
```

What is the interbank lending needed to avoid a bank run in each state?
...
Use the model of _Acemoglu, Ozdaglar & Tahbaz-Salehi (2015)_ for this task.

Below you find two financial networks. Both networks have the same ``\bar y``. 
"""
...
md"""
👉 (X.1 | 2 points) 
Which of these networks is more resilient, which is more stable? Explain. (<100 words)
"""

# ╔═╡ dff68ac2-8437-4abd-b535-e24711503d20
answerX1 = md"""
Your answer goes here ...
"""

# ╔═╡ fe7b421d-a8d7-44b0-a6cc-d01225259e5e
md"""
### Before you submit ...
...
# ╔═╡ 20c4bf5e-78f5-4485-9e7b-c9af1495c2ca
members = let
...
# ╔═╡ e1097aa7-7bdc-49b1-8764-dfe4570b4ceb
begin
