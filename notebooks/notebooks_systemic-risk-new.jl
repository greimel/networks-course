...
md"""
## Model II: Firms (think _Farm_)

* fixed initial size
* two types of capital: machines ``(α)`` and field ``(1-\alpha)``
* fraction ``ℓ`` can be liquidated (recover ``ℓ ζ (A + α)``)
* final pay-off ``(1-ℓ) A``
* dividend ``a - ℓ α`` (machines need replacement)
* dividend and final pay-off are paid proportionally to share-holders
"""
...
# ╔═╡ 0e12e0ca-8931-44a1-9ea8-6447ce1bbe90
md"""
# V. Conclusion
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "06c2b531938be1f2f12a78db4a0402626cbdb751"
