...
HTML("<div style=\"\nposition: absolute;\nwidth: calc(100% - 30px);\nborder: 50vw solid #282936;\nborder-top: 500px solid #282936;\nborder-bottom: none;\nbox-sizing: content-box;\nleft: calc(-50vw + 15px);\ntop: -500px;\nheight: 500px;\npointer-events: none;\n\"></div>\n\n<div style=\"\nheight: 500px;\nwidth: 100%;\nbackground: #282936;\ncolor: #fff;\npadding-top: 68px;\n\">\n<span style=\"\nfont-family: Vollkorn, serif;\nfont-weight: 700;\nfont-feature-settings: 'lnum', 'pnum';\n\"> \n<p style=\"text-align: center; font-size: 2rem;\">\n<em> Co-authorship network of the Tinbergen Institute </em>\n</p>\n</div>\n\n<style>\nbody {\noverflow-x: hidden;\n}\n</style>")
...
# ╔═╡ 80fea77e-e7df-41b5-a128-95d5242ec88d
...
# ╔═╡ 640b6e1f-5ef0-4300-bda3-bb539aa7b72d
md"""
## Graph from edge list
"""

# ╔═╡ 3e9f13d1-923f-405f-8c3d-d53b3ed08e08
#using LinearAlgebra, SimpleWeightedGraphs, SparseArrays, CategoricalArrays, DataAPI

# ╔═╡ 644adc91-237d-49b1-925b-011f7ed4d695
#function graph_from_edges(from, to)
#	nodes = from ∪ to
#	nv = length(nodes)
#
#	from_id = refarray(categorical(from; levels=nodes))
#	to_id   = refarray(categorical(to;   levels=nodes))
#
#	sparse(from_id, to_id, 1, n, n) |> Symmetric |> SimpleGraph
#end
